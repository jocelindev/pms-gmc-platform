(function () {
  ...
  function pptxPackage(slides, title) {
    ...
    const app = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes"><Application>PMS GMC</Application><PresentationFormat>Wide</PresentationFormat><Slides>${slideCount}</Slides></Properties>`;
  ...
  function headerShape(title, subtitle = "") {
    const margin = 520000;
    return [
      pptxTextShape(2, "PMS GMC GROUP", margin, 260000, 2600000, 360000, { fontSize: 1250, bold: true, color: COLORS.gold }),
